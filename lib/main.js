...
Exec.prototype = {
	...
	domain : function( domain, options ){
		var sdb = new simpledb.SimpleDB({keyid: this.creds.key ,secret: this.creds.secret, host: this.creds.region });
	...
	read : function( domain, options ){
		// fallbacks
		options = options || {};
		var nolimit = ( options.limit && options.limit < 2500 ) ? false : true;
